...
namespace MvcBookStore.Controllers
{
    public class AdminController : Controller
    {
        ...
        //Backupp--
        public ActionResult BackupDatabases()
        {
            string connectionString = ConfigurationManager.ConnectionStrings["QLBANSACHConnectionString"].ConnectionString;
            string backupFilePath = @"D:\WebNC\DeTaiASP\DeTaiASP\SQL"; // Đường dẫn tới thư mục chứa tệp sao lưu
            ...
            ViewBag.Message = "Cơ sở dữ liệu đã được sao lưu thành công.";
        ...
        public ActionResult Backup()
            ...
            {
                string connectionString = ConfigurationManager.ConnectionStrings["QLBANSACHConnectionString"].ConnectionString;
                string backupDirectory = @"D:\WebNC\DeTaiASP\DeTaiASP\SQL";
                ...
                try
                {
                    using (SqlConnection connection = new SqlConnection(connectionString))
                    {
                        ...
                        string query = $"BACKUP DATABASE QLBANSACH TO DISK = '{backupFilePath}'";
                    ...
                    ViewBag.Message = "Backup cơ sở dữ liệu thành công.";
                }
                catch (Exception ex)
                {
                    ViewBag.Message = "Backup không thành công. Lỗi: " + ex.Message;
                }
